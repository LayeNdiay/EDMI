...
<body>
    ...
    @endif
    <form action="{{route('etudiant.storePostulerAppel',['id'=>$id])}}" method="post" enctype="multipart/form-data" class="container" id="container">
        @csrf
        <div class="container">
            <h4>Merci de bien vouloir  soumettre votre cv pour valider le Post
            </h4>
            <div id="preview-container">
                <button id="upload-dialog">soummetre votre cv</button>
                <input type="file" id="pdf-file" name="cv" accept="application/pdf" />
