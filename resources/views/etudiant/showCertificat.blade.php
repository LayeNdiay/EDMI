...
<body>
    ...
    @endif
    <form action="{{route('etudiant.storeCertificat',['id'=>$id])}}" method="post" enctype="multipart/form-data" class="container" id="container">
        @csrf
        <div class="container">
            <h4>Merci de bien vouloir  soumettre certificat d'inscription
            </h4>
            <div id="preview-container">
                <button id="upload-dialog">soummetre cerficat </button>
                <input type="file" id="pdf-file" name="certificat" accept="application/pdf" />
