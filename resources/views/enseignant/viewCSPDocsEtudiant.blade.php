      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tbody>
            ...
            <form action="{{route('enseignant.CSP.confirmerPostulat',['slug'=>$etudiant->user->slug])}}" method="POST">
              @csrf
              <td><input type="submit"  value="valider" class="btn btn-primary"></td>
            </form>
            <form action="{{route('enseignant.CSP.refuserPostulat',['slug'=>$etudiant->user->slug])}}" method="POST">
              @csrf
              <td><input type="submit"  value="refuser" class="btn btn-primary "></td>
            </form>
          </tbody>
        </table>
