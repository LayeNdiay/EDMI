...
<body>
    ...
    @endif
    <form action="{{route('enseignant.storeCharte',['slug'=>$etudiant->user->slug])}}" method="post" enctype="multipart/form-data" class="container" id="container">
        @csrf
        <div class="container">
            <h4>Merci de bien vouloir  soumettre le charte de thèse afin de valider l'admission du doctorant
            </h4>
            <div id="preview-container">
                <button id="upload-dialog">soummetre charte de thése</button>
                <input type="file" id="pdf-file" name="charte" accept="application/pdf" />
...
<script>
    ...
    document.querySelector("#upload-dialog").addEventListener('click', function(e) {
        e.preventDefault()
