        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="{{route('enseignant.validerEtudiant',['slug'=>$etudiant->user->slug])}}" class="btn btn-primary ">valider</a></td>
            </tr>
          </tbody>
        </table>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive">
          ...
          <td><a href="{{route('enseignant.validerEtudiant',['slug'=>$etudiant->user->slug])}}" class="btn btn-primary mr-2">valider</a></td>
