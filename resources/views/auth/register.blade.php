            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nomEpoux" class="col-md-4 col-form-label text-md-end">Nom d'epoux</label>

                            <div class="col-md-6">
                                <input id="nomEpoux" type="text" class="form-control @error('nomEpoux') is-invalid @enderror" name="nomEpoux" value="{{ old('nomEpoux') }}" >
